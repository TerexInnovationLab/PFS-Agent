...
class MyClientsState extends State<MyClients> with WidgetsBindingObserver {
  ...
  void _applyClients(List<Map<String, dynamic>> clients) {
    setState(() {
      _clients = clients;
  ...
  Future<void> _pollAndSyncStatuses() async {
    ...
    try {
      ...
      if (anyUiChange && mounted) {
        await ClientListCacheService.instance.saveClients(_clients);
        setState(() {});
      }
    } on TimeoutException {
