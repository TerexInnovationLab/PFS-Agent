...
class _EditprofiledetailsState extends State<Editprofiledetails> {
  ...
  Map<String, String> _collectFormData() {
    String gender = (_selectedGender ?? 'Male').toLowerCase();
    String marital;
    ...
    return {
      ...
      "gender": gender,
      "identity_type": (_selectedId ?? "national_id").toLowerCase(),
  ...
  String _pageSubtitle() {
    switch (pageNumber) {
      case 0:
        return "Start by updating your basic personal information.";
      case 1:
        return "Provide your contact details and Gender.";
      case 2:
